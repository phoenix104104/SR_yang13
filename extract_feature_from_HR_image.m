function [LR_features, HR_features] = extract_feature_from_HR_image(img_HR, parameter)
    ...
    [LR_features, position_all, mean_all] = extract_feature_from_LR_image(img_LR, parameter);
