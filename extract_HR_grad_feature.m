function [LR_features, HR_features, position_all] = extract_HR_grad_feature(img_HR, parameter)
    ...
    [LR_features, position_all, mean_all] = extract_LR_grad_feature(img_LR, parameter);
