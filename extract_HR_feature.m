function [LR_features, HR_features, position_all] = extract_HR_feature(img_HR, parameter, num_patch)
    ...
    [LR_features, position_all, mean_all] = extract_LR_feature(img_LR, parameter, num_patch);
