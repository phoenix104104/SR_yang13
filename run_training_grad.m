function run_training_grad(config_filename)
...
feature_filename = fullfile(output_dir, ...
                            sprintf('kmeans_features_%s_data%d_grad_LR%d_HR%d_corner%d.mat', ...
...
tic;                 
if( exist(feature_filename, 'file') && exist(pca_filename, 'file') )
    ...
    while( true )
        ...
        for i = 1:num_images
            ...
            [feature, ~] = extract_LR_grad_feature(LR_img, parameter, num_patch_per_image);
...
label_filename = fullfile(output_dir, ...
                          sprintf('label_position_%s_data%d_grad_LR%d_HR%d_corner%d_center%d.mat', ...
                          parameter.training_dataset, ...
                          parameter.num_patches_for_kmeans, ...
                          parameter.LR_patch_size, ...
                          parameter.HR_patch_size, ...
...
if( exist(label_filename, 'file') )
    ...
    for i = 1:num_images
        ...
        [LR_features, LR_position] = extract_LR_grad_feature(LR_img, parameter);
...
parameter_tag = sprintf('%s_data%d_grad_LR%d_HR%d_corner%d_center%d_nn%d', ...
                        parameter.training_dataset, ...
                        parameter.num_patches_for_kmeans, ...
                        parameter.LR_patch_size, ...
                        parameter.HR_patch_size, ...
    ...
    for c = 1:parameter.num_cluster
        ...
        if( exist(feature_filename, 'file') )
            ...
            for i = 1:num_images
                ...
                [LR_features, HR_features] = extract_HR_grad_feature_from_position(...
