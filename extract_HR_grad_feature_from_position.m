function [LR_features, HR_features] = extract_HR_grad_feature_from_position(...
                                            img_HR, parameter, position)
    ...
    [LR_features, mean_all] = extract_LR_grad_feature_from_position(img_LR, parameter, position);
